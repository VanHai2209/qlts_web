...
import { WorkerInputSchema, WorkerInputType } from "./types";
import { IDepartment, IWorker } from "@/libs/types/category";
...
export const WorkerForm = ({ data, departments }: Props) => {
  const isEdit = !!data;
  ...
  const onSubmit = async (data: WorkerInputType) => {
    mutateAsync({
      ...data,
